...
{
    //This code controls behaviour of the upper arrow button (on the left side of the platform) that allows user to change colours of balls from which they choose
